  ...
  const data = [
    {
      ...
      anim: "",
      title:
        "Multiple Personal Protective Equipment for Construction Safety Monitoring System",
      description:
    ...
    },
    {
      ...
      description:
        "A web application that manages the evaluation of faculty members in the computer engineering department at Technological Institute of the Philippines - Quezon City. It was conducted for the faculty members to see their performance based on the requirements provided by the head of the department.",
    ...
    },
    {
      ...
      title:
        "AI-Aided Traffic Regulatory and Warning Signs Detection for Driver Awareness",
      description:
        "A python-based software application that uses state-of-the-art object detection algorithm (YOLO) to detect regulatory and warning traffic signs with automated voice notification system.",
    ...
    },
    {
      ...
      description:
        "An A* star pathfinding algorithm simulation in a tilemap scrolling environment made in Python with PyGame Library.",
    ...
    },
    {
      ...
      description:
        "A GUI desktop application for meat shop management that handles the sales and storage of various types of meat products. It performs operations similar to CRUD from scratch without relying on a database management system such as SQLite or MySQL.",
    ...
    },
    {
      ...
      description:
        "A Windows-based batch testing script designed to execute various test cases on small C++ programs, particularly valuable for instructors and learners. For instance, it can be employed to evaluate homework assignments submitted by students in a classroom setting.",
